...
/*   Updated: 2019/07/08 15:48:25 by hhow-cho         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_node_ht				*ft_ht_add(t_ht *hash, const char *key, void *datum);
t_node_ht				*ft_ht_get(t_ht *hash, const char *key);
void					ft_ht_free(t_ht **p_hash);
